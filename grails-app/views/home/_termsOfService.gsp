...
<p><strong>Effective 21 August 2013</strong>
<p>By using this website (the “Site”), you agree to follow and be bound by the following Privacy Policy and the terms
and conditions concerning your use of the Site ("Terms of Service"). We may modify or terminate our services from time
to time, for any reason, and without notice. We reserve the right to modify the Privacy Policy and Terms of Service from
time to time, for any reason, without notice. Please review the Privacy Policy and Terms of Service periodically so that
you will be apprised of any changes.
<p><h3>Privacy Policy</h3>
<p>The data you generate, aggregate, track and compile with our service belong to you. We are providing a platform
...
and 4) full privacy, no sharing. We suspect different users will want these levels of differential privacy depending on the
...
<p>This Privacy Policy applies to Web sites and services that are operated by Curious, Inc. ("The Company"). Curious, Inc. is not
...
<p><ul>
<li>Content in the form of tags (a word or set of words) describing things you’re interested in tracking, e.g. migraine headache, aspirin, pain level.</li>
<li>Device and app data (e.g. Fitbit, Withings, Basis etc)</li>
<li>Lab results that you enter.</li>
<li>Genetic data</li>
<li>Other biodata</li>
</ul>
<p><strong>Website Data Collection</strong>
<p>In addition to the data you input into Curious, in order to provide our full range of services, we may collect the following
...
<li>Cookies - When you visit Curious, Inc., we may send one or more cookies - a small file containing a string of
...
However, most features and services of Curious, Inc. will not function properly if your cookies are disabled.</li>
...
<li>User communications - When you send email or other communication to Curious, Inc., we may retain those communications
in order to process your inquiries, respond to your requests and improve our services.</li>
<li>Embedded URLs - In order to provide maximum site utility, Curious, Inc. may also use a tracking technique that uses
...
the session. While this increases your ability to surf the Site, it does not replace the functionality or streamlining
of cookies and may limit your use of many convenience features offered by the Site.</li>
</ul>
<p><strong>Information Use</strong>
<p>We use information we collect for the following purposes:
<p><ul>
<li>Auditing, research and analysis in order to maintain, protect and improve our services</li>
<li>Providing our services to users, including the display of customized content</li>
<li>Ensuring the technical functioning of our network</li>
</ul>
<p><strong>Information Sharing</strong>
<p>Curious, Inc. may use analytics services provided by third parties. These services can use cookies to help the
...
other services relating to website activity and internet usage. Analytics service providers may also transfer this
information to third parties where required to do so by law, or where such third parties process the information on
the services' behalf. You may refuse the use of cookies by selecting the appropriate settings on your browser,
however please note that if you do this you will not be able to use the functionality of this website. By using
this website, you consent to the processing of data about you in the manner and for the purposes set out above.
<p><strong>Data Security</strong>
<p>To prevent unauthorized access, maintain data accuracy, and ensure the appropriate use of information, we
have put in place appropriate physical, electronic, and managerial procedures to protect the information we
collect online.
...
locations may be unknown to Curious, Inc. It may also be processed by staff who work for us or for one of our
...
do our best to protect your personal data, we cannot guarantee the security of your data transmitted to our website;
...
3.0 Unported (“CC BY 3.0”) license</a>. Curious, Inc. reserves the right to move to more recent versions of the CC
BY license as they become available. Attribution should be made to Curious, Inc. including a link to the front
...
data set carries information indicating rights to use any data uploaded by users of Curious, Inc.
software and websites. You must take proper steps to comply with privacy settings associated with any data
available through Curious, Inc. as defined in the Privacy Policy. Curious, Inc. makes no claims about the
...
Curious, Inc. and/or its collaborators. Use of the Software is governed by the terms of the Software
...
<p>The Curious, Inc. website may contain copies of documents other than the website information and data,
...
<p><ul>
<li>Your use of the information is for informational, personal, and non-commercial purposes only; 
<li>You will display the copyright notice and other proprietary notices pertaining to the individual sources
if you redistribute or use them.
</ul>
<p><strong>Submissions</strong>
<p>To make a submission of any copyrighted material to the Site you must either be the copyright owner or
have the explicit permission of the copyright owner to do so. We will not be responsible, or liable to any
third party, for the content or accuracy of any materials posted by you or any other user of our website. For
data, you must either be the person about whom the data is gathered and concerns or have been provided
sufficient permissions by that person (up to and including informed consent under HIPAA, the Common Rule,
or other relevant national privacy legislation regarding health data) to enable you to post and share
the data.
...
Curious, Inc. immediately of any unauthorized use of your password(s). Curious, Inc. is concerned about the
...
information as confidential, and you must not disclose it to any third party. We have the right to disable
...
<p>You agree that Curious, Inc. may terminate or suspend your access to the Site and any account(s)
for Cause, wherein Cause shall mean (1) misconduct by the user of the Curious, Inc. website, (2)
...
stating the reasons for the termination or suspension. Access to the Site may be monitored by Curious, Inc.
...
including users, advertisers, affiliates and sponsors of the Site. You agree that Curious, Inc.
...
You agree that Curious, Inc. is not responsible for third party content accessible through the Site,
...
third party, your relationship is directly with the third party. You agree that Curious, Inc.
...
<p>You agree that Curious, Inc. is not responsible for any loss or damage of any sort you may incur
from dealing with any third party.
<p><strong>Copyright/Database Notice and Take-down Policy</strong>
<p>It is the policy of Curious, Inc. to respond to all notices of alleged copyright or database
rights infringement. Curious, Inc. is not responsible for content on other websites that users might query
or otherwise discover while using Curious, Inc. websites and other online properties. 
<p>This notice describes the information that must be provided in notices alleging copyright or database
rights infringement found specifically on Curious, Inc. websites and other online properties. The goal of the
policy is to make alleged infringement notices to Curious, Inc. as straightforward as possible, both
for the alleging party and for the Company to review. 
<p>Curious, Inc., at its sole discretion, reserves the right to disable user accounts of Curious, Inc. websites
and other online properties that may infringe upon the copyrights, database rights, or other intellectual
property rights of Curious, Inc. and/or others. 
<p>In response to notices of alleged copyright or database rights infringement, Curious, Inc. reserves the
right to remove the content (including but not limited to data, publications, documents, and graphics) claimed
to be a copyright, database rights, privacy, or trade secrets infringement. If Curious, Inc. removes or disables
...
<p>To file a notification of claimed infringement, you will need to send a written communication that includes
substantially all of the information listed below. (Please consult your legal counsel to confirm these requirements): 
<p><ol>
<li>A physical or electronic signature of a person authorized to act on behalf of the owner ("authorized person") of
an exclusive right that is allegedly infringed.
<li>Identification of the work claimed to have been infringed, or, if multiple works are covered by a single notification,
...
<li>Information reasonably sufficient to permit the Company to contact the authorized person, such as an address,
telephone number, and, if available, an electronic mail address. 
<li>A statement that the authorized person has a good faith belief that use of the material in the manner complained of
is not authorized by the copyright owner, its agent, or the law. 
<li>A statement that the information in the notification is accurate, and under penalty of perjury, that the authorized
...
<p><strong>Counter-Notification Policy</strong>
<p>When the Company receives a takedown notification of alleged infringement, the Company removes the material
that is the subject of the notification. If the Company removes materials that you have uploaded onto the Company
website or other online properties, the Company will attempt to contact you about it. 
<p>If you believe your content was removed as a result of mistake or misidentification, you may submit a
Counter-Notification that includes substantially all of the information listed below. 
<p><ol>
<li>Your name, address, telephone number and physical or electronic signature;
<li>Identification of the material and its location before removal;
<li>A statement under penalty of perjury that the material was removed by mistake or misidentification; and
<li>A statement that you will accept service of process from the person who provided notification of claimed infringement. 
</ol>
<p>Such written notification should be sent to our designated agent via email.
<p>Upon receipt of a Counter-Notification containing the information as outlined in 1 through 4 above: 
<p><ul>
<li>Curious, Inc. shall promptly provide the Complaining Party with a copy of the Counter-Notification;
<li>Curious, Inc. shall inform the Complaining Party that it will replace the removed material or cease disabling access to it within ten (10) business days;
<li>Curious, Inc. shall replace the removed material or cease disabling access to the material within ten (10) to fourteen (14) business days following receipt of the Counter-Notification, provided Curious, Inc.’s Designated Agent has not received notice from the Complaining Party that an action has been filed seeking a court order to restrain Subscriber from engaging in infringing activity relating to the material on Curious, Inc.'s system.
</ul>
...
<p>Please note that in addition to being forwarded to the person who provided the allegedly infringing content,
a copy of this legal notice (with your personal information removed) may be published.
<p>A link to your published letter may be displayed in place of the removed content. 
<p><strong>Medical/Clinical Use Disclaimer</strong>
<p>Materials on this Site have not necessarily been reviewed or approved by relevant clinical authorities.
<p>All materials on this Site are provided for informational and review purposes. It is not intended to and
...
read on or accessed through the Site. Curious, Inc. assumes no responsibility for any injury and/or damage
...
products and services provided on the Site, are provided on an "as is" and "as available" basis. Curious Inc.
...
Curious Inc. makes no warranty that:
<p><ul>
...
<li>The results that may be obtained from the use of the Site or any services offered through the Site
...
the Site is done at your own discretion and risk. Curious Inc. shall have no responsibility for any damage
to your computer system or loss of data that results from the download of any content, materials, information
or software. Curious Inc. reserves the right to make changes or updates to the Site at any time without notice.
<p><strong>Limitation of Liability</strong>
<p>In no event shall Curious Inc. be liable for any direct, indirect, incidental, special or consequential
...
<p>You agree to defend, indemnify and hold harmless Curious, Inc., its staff and associates, from and against
...
<p>You must not misuse our website by knowingly introducing viruses, trojans, worms, logic bombs or other material
that is malicious or technologically harmful. You must not attempt to gain unauthorized access to our website,
the server on which our website is stored or any server, computer or database connected to our website. You must
not attack our website via a denial-of-service attack or a distributed denial-of service attack.
<p>By breaching this provision, you would commit a criminal offence under the legislation in some countries.
...
other proprietary material due to your use of our website or to your downloading of any material posted on it,
...
<p>You must not establish a link from any website that is not owned by you.
<p>Our website must not be framed on any other site without our express permission.
<p><strong>Links from our Site</strong>
<p>Where our website contains links to other sites and resources provided by third parties, these links
are provided for your information only. We have no control over the contents of those sites or resources,
and accept no responsibility for them or for any loss or damage that may arise from your use of them.
<p><strong>Jurisdiction and Applicable Law</strong>
<p>Delaware courts will have exclusive jurisdiction over any claim arising from, or related to, a visit
to our website [although we retain the right to bring proceedings against you for breach of these conditions
in your country of residence or any other relevant country].
<p>These Terms of Service and any dispute or claim arising out of or in connection with them or their
...
<p>We may revise the Privacy Policy or Terms of Service at any time by amending the
<a href="/home/termsofservice">Privacy Policy and Terms of Service</a> page. You are expected to check
...
<div class="terms2">
<h3>LAM Health Project Members</h3>
<p>Users signing up on this Site are participating in a service jointly provided by Curious and the LAM Health Project. The following
terms apply to these users.
<p><strong>How your data may be used</strong>
<p>In order to help researchers and to learn from our collective experiences of LAM, the data you input into the Curious,
Inc. website may be aggregated and made available to other members or researchers in aggregate non-identifiable form.
For example, we may report the number of patients trying a particular treatment or the number of patients experiencing
a particular symptom. This aggregate data will not include your personal information.
<p>The information you add to our database will be used for research purposes only. For example, we may look at
scientific questions such as, “Is there a correlation between certain symptoms and environmental factors?”
Utilizing your aggregate data to look at these types of questions may prompt researchers to explore such questions
in more depth through formal research studies. At Curious and in conjunction with the LAM Health Project and
external researchers, we’re interested in better understanding the experience of living with chronic conditions
like LAM and improving treatment options and health outcomes for everyone, including people with LAM.
In addition, we strive to help you explore and understand your own condition through the tools we have provided on the website.
</div>
</g:if>
