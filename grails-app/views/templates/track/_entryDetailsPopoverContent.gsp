		...
		<form class="entry-details-form">
			...
			<li>
				...
				<span class="checkbox-orange">
					<input type="checkbox" name="repeat" {{- RepeatType.isRepeat(repeatType) ? 'checked' : ''}} class="repeat-entry-checkbox" value="repeat" id="{{= editType }}-repeat-checkbox">
					<label for="{{= editType }}-repeat-checkbox"></label>
				</span>
			</li>
			<li class="repeat-modifiers {{- RepeatType.isRepeat(repeatType) ? '' : 'hide'}}">
				<ul>
					...
					<li>
						...
						<div class="repeat-frequency-radio-group">
							...
							<input type="radio" id="{{= editType }}-weekly" {{- RepeatType.isWeekly(repeatType) ? 'checked' : ''}} value="weekly" name="{{= editType }}-repeat-frequency"/>
							<label for="{{= editType }}-weekly"><span></span>Weekly</label>
							<input type="radio" id="{{= editType }}-monthly" {{- RepeatType.isMonthly(repeatType) ? 'checked' : ''}} value="monthly" name="{{= editType }}-repeat-frequency"/>
					...
					<li>
						...
						<span class="checkbox-orange">
							<input type="checkbox" {{- RepeatType.isGhost(repeatType) ? 'checked' : ''}} name="repeat" value="repeat" id="{{= editType }}-confirm-each-repeat">
			...
			<li>
				...
				<span class="checkbox-orange">
					<input type="checkbox" {{- RepeatType.isRemind(repeatType) ? 'checked' : ''}} name="remind" value="remind" id="{{= editType }}-remind-checkbox">
