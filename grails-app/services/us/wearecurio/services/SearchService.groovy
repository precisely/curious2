        ...
        elasticSearchHelper.withElasticSearch{ client ->
            ...
            for (def d : readerGroupDiscussions.searchResults ) {
                ...
                if (bucket) {
                    ...
                    //model["discussionList"][d.id]["totalComments"] = bucket.docCount
                    ...
                    //model["discussionList"][d.id]["totalComments"] = 0
                ...
                if (firstPost) {
                    ...
                    //model["discussionList"][d.id]["isPlot"] = (firstPost.plotDataId != null && firstPost.plotDataId > 0) 
                    //model["discussionList"][d.id]["firstPost"] = firstPost
                }
                ...
                //model["discussionList"][d.id]["isAdmin"] = (d.userId == user.id)
...
//                            model["discussionList"][d.id]["groupId"] = gid
//                            model["discussionList"][d.id]["groupName"] = groups[0].fullName
//                            if (model["discussionList"][d.id]["isAdmin"]) {
...
//                            model["discussionList"][d.id]["isAdmin"] = true
