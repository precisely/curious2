...
$(function() {
	...
	var execute_correlation_action = function(action, correlation_id) {
	...
	var action_handler = function() {
		...
		execute_correlation_action(action, correlation_id);
	};
	...
	$('#garbage-can-icon').on('click', function() {
		execute_correlation_action('noise', garbageId);
		fadeGarbageBin();
